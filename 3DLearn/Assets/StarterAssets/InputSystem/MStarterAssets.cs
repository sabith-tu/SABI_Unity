// GENERATED AUTOMATICALLY FROM 'Assets/StarterAssets/InputSystem/MStarterAssets.inputactions'
...
public class @MStarterAssets : IInputActionCollection, IDisposable
{
    public InputActionAsset asset { get; }
    public @MStarterAssets()
    {
    ...
    {
        private @MStarterAssets m_Wrapper;
        public PlayerActions(@MStarterAssets wrapper) { m_Wrapper = wrapper; }
